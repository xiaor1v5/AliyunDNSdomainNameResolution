...
namespace Aliyun.Acs.Core.Regions
{
    ...
    {
        private readonly string BundledEndpointsResourcePath = AppDomain.CurrentDomain.BaseDirectory + "endpoints.xml";
        ...
        {
            var xmlDoc = XDocument.Load(BundledEndpointsResourcePath);
